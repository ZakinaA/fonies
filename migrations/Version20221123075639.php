 ...
 */
final class Version20221123075639 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tranche ADD CONSTRAINT FK_66675840357C0A59 FOREIGN KEY (tarif_id) REFERENCES tarif (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE type_cours ADD CONSTRAINT FK_F3C60B6B357C0A59 FOREIGN KEY (tarif_id) REFERENCES tarif (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
